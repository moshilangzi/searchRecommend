...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="http://static4.yufei.com/3rd-lib/jquery-1.8.3.min.js" type="text/javascript" charset="utf-8"></script>
                ...
                <tr>
                    ...
                    <td>
                        <select id="action" name="action" style="width: 300px; height: 30px;">
                            <option value="/inner/searchRecommend/recommend.json">用户推荐：/inner/searchRecommend/recommend.json</option>
                            <option value="/inner/searchRecommend/search.json">用户搜索：/inner/searchRecommend/search.json</option>
