...
public class SearchServiceRule extends ServiceRule {
  ...
  public SearchServiceRule(String appId, String appName, String filter, String sort,
      String cacheStrstegy) {
    super(appId, appName);
  ...
  public String toString() {
    return "SearchServiceRule{" + "filter=" + filter + ", sort=" + sort + ", cacheStrategy="
        + cacheStrategy + '}';
  }
  ...
  public boolean equals(Object obj) {
    ...
    if ((this.cacheStrategy == null) ? (other.cacheStrategy != null)
        : !this.cacheStrategy.equals(other.cacheStrategy)) {
      return false;
    }
    return true;
  }
