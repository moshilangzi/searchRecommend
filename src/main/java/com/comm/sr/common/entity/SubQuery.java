...
public class SubQuery implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (subQuerys != null ? !subQuerys.equals(subQuery.subQuerys) : subQuery.subQuerys != null)
      return false;
    return !(queryItem != null ? !queryItem.equals(subQuery.queryItem)
        : subQuery.queryItem != null);
  ...
  public String toString() {
    return "SubQuery{" + "logic='" + logic + '\'' + ", subQuerys=" + subQuerys + ", queryItem="
        + queryItem + '}';
  }
