...
public class EsCommonQuery extends CommonQuery {
  ...
  public EsCommonQuery(int pageNum, int pageSize, List<SortItem> sortItems, List<String> fls,
  ...
  public boolean equals(Object o) {
    ...
    return !(scoreScript != null ? !scoreScript.equals(that.scoreScript)
        : that.scoreScript != null);
  ...
  public String toString() {
    return "EsCommonQuery{" + "index='" + index + '\'' + ", type='" + type + '\''
        + ", scoreScript='" + scoreScript + '\'' + "} " + super.toString();
  }
}
