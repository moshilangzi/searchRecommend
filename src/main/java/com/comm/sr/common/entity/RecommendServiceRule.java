...
public class RecommendServiceRule extends SearchServiceRule {
    ...
    public RecommendServiceRule(String appId, String appName, String filter, String sort, String cacheStrstegy, boolean ifWriteIntoUserRelations, boolean ifDuplicateFromUserRelations) {
