 ...
 */
public class VcgEpSearchService extends AbstractComponent{
  static{
    try {
  ...
  public VcgEpSearchService(Properties settings, AbstractQueryService queryService,
...
//    results_.addAll(newImageList);
    ...
    final  String imageDomain="http://goss2.asiacn.vcg.com/";
