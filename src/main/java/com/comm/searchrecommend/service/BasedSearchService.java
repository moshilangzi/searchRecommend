 ...
 */
public abstract class BasedSearchService<A extends AbstractQueryService,Q extends CommonQuery, SR extends SearchServiceRule, R2> implements Serializable {
    ...
    public BasedSearchService(A queryService) {
        this.queryService = queryService;
    }
