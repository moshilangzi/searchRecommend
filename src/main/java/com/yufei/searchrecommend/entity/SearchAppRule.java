 ...
 * @author jasstion
 */
public class SearchAppRule extends AppRule{
    ...
    public SearchAppRule() {
        super();
    }
    
    public SearchAppRule(String appId, String appName,String filter,String sort,String cacheStrstegy) {
        super(appId, appName);
    ...
    public String toString() {
        return "SearchAppRule{" + "filter=" + filter + ", sort=" + sort + ", cacheStrategy=" + cacheStrategy + '}';
    }

    public SearchAppRule(String appId, String appName) {
        super(appId, appName);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SearchAppRule other = (SearchAppRule) obj;
